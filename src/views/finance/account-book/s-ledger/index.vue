      ...
      <el-col :span="20" :xs="24">
        ...
        <div class="table-p" :style="{ 'min-height': minHeight }">
          <el-table v-loading="loading" :data="dataList">
            <el-table-column label="凭证编号" prop="a" />
            <el-table-column label="时间" prop="b" />
            <el-table-column label="摘要" prop="c" />
            <el-table-column label="借方" prop="d" />
            <el-table-column label="贷方" prop="e" />
